...
<!-- File name: viewscheduled.php
     ...
     Description: This script will allow a professor to view, add, and remove advising times. -->


<head>
  <title>Available Appointments (HW9)</title>
...
<h3 align="center">
  ...
  <tr>
  <td bgcolor = darkgrey colspan = 5 align = center><font color = black>Available Appointments
  <tr>
  ...
  <?php
    ...
    echo "<form method = 'post' action = 'viewopen.php'>";
    ...
    while($row = mysqli_fetch_object($result))
    {
      ...
      echo("
        ...
        <td bgcolor = $bgColor> <input type = 'submit' action = 'viewopen.php' name = delete value = '$row->id'>
          ");
    }
  ...
  <form action='viewscheduled.php'>
    <input type='submit' value='View Scheduled Appointments' />
  </form>

  <hr>

  <form method = "post" action = "viewopen.php">
    <pre>
     New Note:
